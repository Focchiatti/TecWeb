...
\begin{document}
	...
	\subsection{Test}
	I test sono stati effettuati senza intermediari sui seguenti Browser:
	\begin{itemize}
		\item \textbf{Chrome 64}: sito correttamente visualizzato
		\item \textbf{Safari 11}:
		\item \textbf{Edge 41}:
			\begin{itemize}
				\item 
				\item 
		...
		\item \textbf{Opera 50}:
			...
			\end{itemize}
	\end{itemize}
	Tramite il servizio \textit{Browsercheck}\footnote{\url{prova}}, sulle seguenti versioni di Explorer:
	\begin{itemize}
	 	\item \textbf{E 11}:
	 		\begin{itemize}
	 			\item 
